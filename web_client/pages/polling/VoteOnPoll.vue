<template>
  <div class="ml-5">
    <h2 class="text-heading-lg md:text-heading-m font-heading mb-2">Today's Issue</h2>
    <br />
        ...
        <form v-if="poll.pollId === $props.pollId" @submit.prevent="recordUserAnswer">
            ...
            <ul>
                <li v-for="answer in poll.answers" :key="answer.answerId">
                    <input type="radio" v-bind:id="answer.answerId" v-bind:value="answer.answerId" v-model="answerPicked">
...
export default {
            ...
            userSpecificPolls: [
                {
                    ...
                    "description": "What is your opinion on replacing the electoral college with a national popular vote?",
                    "displayOrder": 1,
                    "answers": [
                        {
                ...
                },
                {
                    ...
                    description: "Should Congress pass a second round of stimulus checks?",
                    displayOrder: 2,
                    answers: [
                        {
                ...
                },
                {
                    ...
                    description: "How do you feel about Andrew Yang running for Mayor of New York?",
                    displayOrder: 3,
    ...
    methods: {
        recordUserAnswer() {
            let userId = "b8aa17a8-7757-4d6d-a4c6-d6757f1181dc";
            if (this.answerPicked) {
                 axios.post(`https://ccusbackendcontituentpolling.azurewebsites.net/api/v1/${userId}/polls/${this.$props.pollId}`, { answerId: this.answerPicked}, { 
                    headers: { 
