<template>
    <div
        v-if="showModal"
        class="tw-fixed tw-inset-0 tw-flex tw-items-center tw-justify-center tw-z-50 tw-overflow-auto"
    >
        <transition
        ...
        >
            <div v-if="showBackdrop">
                ...
                ></div>
                <div
                    class="tw-absolute tw-top-0 tw-right-0 tw-px-5 tw-py-4 tw-cursor-pointer"
                    @click="open = false"
                >
                    <svg
