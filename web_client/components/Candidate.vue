<template>
    <div
        class="tw-border tw-border-base-lighter tw-rounded tw-flex tw-flex-col tw-w-72"
    >
        <img
            :src="profilePic"
            :alt="name"
            class="tw-h-40 tw-w-auto tw-object-cover tw-object-top"
        />
        <div class="tw-p-6 tw-flex tw-flex-col tw-justify-between tw-h-full">
            ...
            <div class="tw-mt-8 tw-flex tw-flex-col tw-items-center">
                <a
                    :href="votingRecord"
                    class="tw-text-center tw-block tw-underline"
                    >See Voting Record</a
                >
                <a :href="contactURL" class="usa-button tw-block tw-mt-6"
                    >Contact {{ officeType }} Office</a
                >
            </div>
        </div>
    </div>
